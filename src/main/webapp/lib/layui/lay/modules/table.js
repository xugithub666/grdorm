...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
        ...
        var r = {
            ...
            exports: {title: "下载", layEvent: "LAYTABLE_EXPORT", icon: "layui-icon-export"},
        ...
        a.layTool.on("click", "*[lay-event]", function (e) {
            ...
            switch (layui.stope(e), R.trigger("table.tool.panel.remove"), l.close(a.tipsIndex), c) {
                ...
                case"LAYTABLE_EXPORT":
                    r.ie ? l.tips("下载功能不支持 IE，请用 Chrome 等高级浏览器下载", this, {tips: 3}) : s({
                        list: function () {
                            return ['<li data-type="csv">下载到 Csv 文件</li>', '<li data-type="xls">下载到 Excel 文件</li>'].join("")
                        }(), done: function (e, i) {
                            i.on("click", function () {
