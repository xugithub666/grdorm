...
public interface VisitorDao {
     ...
     * @throws Exception
     */
    @Insert("insert into visitors(id,name,sno,phone,place,begin_date,end_date,visit_result,image) values(#{id},#{name},#{sno},#{phone},#{place},#{begin_date},#{end_date},#{visit_result},#{image})")
